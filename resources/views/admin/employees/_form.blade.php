...
<div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm p-6 sm:p-8">
    ...
    <div class="mt-6">
        ...
        <textarea id="address" name="address" rows="3" class="w-full rounded-lg border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-amber-500 focus:ring-amber-500/20 shadow-sm text-sm px-3 py-2">{{ old('address', $employee?->address) }}</textarea>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        <div>
            ...
            <select id="role" name="role" class="form-select w-full rounded-lg border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 focus:border-amber-500 focus:ring-amber-500/20 shadow-sm text-sm h-10 px-3" @disabled(! auth()->user()->can('employees.assign_role'))>
        ...
        <div>
            ...
            <select id="status" name="status" class="form-select w-full rounded-lg border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 focus:border-amber-500 focus:ring-amber-500/20 shadow-sm text-sm h-10 px-3">
