<x-admin-layout :title="'Edit Agent — ' . $agent->name">
    <div class="mb-6">
        <!-- Breadcrumbs -->
        ...
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-2xl font-bold tracking-tight text-slate-950 dark:text-white">Edit Agent</h1>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.agents.update', $agent) }}" enctype="multipart/form-data" class="space-y-6">
        @csrf
        @method('PUT')
