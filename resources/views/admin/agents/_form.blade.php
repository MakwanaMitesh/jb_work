...
<div class="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl shadow-sm p-6 sm:p-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        ...
        <div>
            ...
            <x-text-input id="mobile_number" type="text" name="mobile_number" :value="old('mobile_number', $agent?->mobile_number)" />
    ...
    <div class="mt-6">
        ...
        @if ($agent?->profilePhotoUrl())
            <img src="{{ $agent->profilePhotoUrl() }}" alt="" class="rounded-full mt-3 w-14 h-14 object-cover">
        @endif
    </div>
</div>
