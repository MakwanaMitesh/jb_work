<x-admin-layout title="Create Loan Product" :white-bg="true">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold tracking-tight text-slate-950 dark:text-white">New Loan Product</h1>
    </div>

    <form method="POST" action="{{ route('admin.loan-products.store') }}">
        @csrf
