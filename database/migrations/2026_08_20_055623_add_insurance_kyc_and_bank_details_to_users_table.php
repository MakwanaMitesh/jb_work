...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            // Insurance Details
            $table->string('insurance_policy_number')->nullable()->after('profile_photo_path');
            $table->string('insurance_policy_pdf_path')->nullable()->after('insurance_policy_number');
            $table->date('insurance_start_date')->nullable()->after('insurance_policy_pdf_path');
            $table->date('insurance_end_date')->nullable()->after('insurance_start_date');

            // Qualification & Contact Info
            $table->string('qualification')->nullable()->after('insurance_end_date');
